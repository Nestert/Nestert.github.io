...
В списках живописи, графики и объектов каждая серия начинается с новой строки и отделяется увеличенным пустым отступом без дополнительного заголовка. Блок работ без серии также начинается с новой строки; последовательные работы без серии выводятся вместе.
