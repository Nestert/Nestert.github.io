...
В списках живописи, графики и объектов переход между сериями отмечается увеличенным пустым отступом без дополнительного заголовка. Работы без серии выводятся единым блоком.
